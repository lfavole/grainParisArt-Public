"""
Django settings for grainparisart project.
...
dotenv.load_dotenv(BASE_DIR / ".env.sample")
...
DEBUG_TOOLBAR_CONFIG = {
    "SHOW_TOOLBAR_CALLBACK": "grainparisart.settings.show_toolbar",
}


def show_toolbar(request):
    return request.user.is_authenticated and request.user.has_perm("users.can_see_debug_toolbar")


ROOT_URLCONF = "grainparisart.urls"
...
WSGI_APPLICATION = "grainparisart.wsgi.application"
